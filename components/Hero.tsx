...
const Hero = () => {
  return (
    ...
    >
      <h1 className="bg-clip-text text-transparent text-center bg-gradient-to-b from-neutral-900 to-neutral-700 dark:from-neutral-600 dark:to-white text-2xl md:text-4xl lg:text-7xl font-sans py-2 md:py-10 sm:py-5 relative z-20 font-bold tracking-tight">
        Amr Hassan Hafez
        <br />
        <TextGenerateEffect
