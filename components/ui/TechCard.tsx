...
export function TechCard({ className }: { className?: string }) {
  return (
    <Card className={className}>
      ...
      <CardTitle>Different Tech Stacks</CardTitle>
      <CardDescription>
        During my journey, I have been exploring different tech stacks.
      </CardDescription>
    </Card>
  );
}
    ...
    <div className="p-8 overflow-hidden h-full relative flex items-center justify-center">
      <div className="flex flex-row flex-shrink-0 justify-center items-center gap-2">
        ...
        <Container className="h-12 w-12 circle-2">
          <SiFlutter className="h-6 w-6 text-blue-300" />
        </Container>
        <Container className="circle-3">
          <SiNextdotjs className="h-8 w-8 text-black dark:text-white" />
        </Container>
        <Container className="h-12 w-12 circle-4">
          <SiNodedotjs className="h-6 w-6 text-green-500" />
        </Container>
        <Container className="h-8 w-8 circle-5">
          <SiThreedotjs className="h-6 w-6 text-black dark:text-white" />
        </Container>
      </div>
...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "max-w-sm w-full h-full mx-auto p-8 rounded-xl border border-[rgba(255,255,255,0.10)] dark:bg-transparent bg-transparent shadow-[2px_4px_16px_0px_rgba(248,248,248,0.06)_inset] group",
        className
      )}
    >
      {children}
